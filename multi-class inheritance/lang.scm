(module lang (lib "eopl.ss" "eopl")
  ...
  (define the-grammar
    '((program ((arbno class-decl) (arbno class-extend-merge) expression) a-program)
      ...
      (class-extend-merge
        ("classmerge" identifier "=" identifier "&" identifier)
        class-extend-merge-decl)
      ...
      (expression
       ("setfield" identifier identifier "=" expression)
       setfield-exp)
